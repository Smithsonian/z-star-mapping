...
We found `print(n_gauges)` NOAA tide gauges that were both listed in the NOAA Datum Errors report, and had complete MHHW, MHW, and MSL datums. We found that $\rho_{mhw,msl}$ and $\rho_{mhhww,msl}$ where `ro_mhw_msl` and `ro_mhh_msl` respectively. 
