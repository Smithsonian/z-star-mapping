...
For the analyses we compiled coastal LiDAR-based digital elevation models from multiple sources, with the goal of geographic completness and the most up-to-date surveys. The majority of the files were aggregated for the NOAA Sea Level Rise viewer. The underlying aggregated DEMs for the sea-level rise viewer however are not representative of all the data used for the sea-level rise viewer, or the extent of historically tidal wetlands. We additionally aggregated DEMs from the Northern Gulf of Mexico; the Sacramento Delta in CA; Baltimore, and Calvert Counties in Maryland; Beaufort, and Glynn Counties in South Carolina; Georgia; Mobile County, Alabama; and the Northwestern Outer Coast of Washington State. We created all maps in ArcGIS Pro (2.0.1). 
