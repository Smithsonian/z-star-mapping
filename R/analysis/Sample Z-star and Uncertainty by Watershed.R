...
geo_files <- "F:/z-star-spatial-data/temp/RSLR/"
...
write_csv(all_sumstats, "All-HUC8-RSLR-Medians.csv")

## MHW-MSL #########
geo_files <- "F:/z-star-spatial-data/temp/MHW_MSL/"
...
write_csv(all_sumstats, "All-HUC8-MHW-MSL-Medians.csv")