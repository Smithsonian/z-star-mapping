...
arcpy.env.scratchWorkspace = "F:/temp/ArcScratch"
...
min_year = 1888
max_year = 2013
hydroflattening_value = -99

# set up outpaths
in_raster_name = in_raster_path.split("/")[-1]

# Cut out other unnecessary pieces
stringsToCutOut = ["_GCS", "_5m", "_10m", "_3m", "_NAVDm", "_NAVD88m", "_dist", "_Topobathy_DEM", "JH", "_5ft", "_m", "_2m", "_DEM2013", "_30m"]
...
def mhhws_prop(in_dem,
    ...
    try:
        ...
        # nothing
        logger.info("Process failed: {} with PIC {}".format(current_process().name, os.getpid()))
